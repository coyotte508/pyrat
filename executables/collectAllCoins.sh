...
#   The objective here is to collect all the coins in the maze.
#
#   In this game, the map of the maze and the coins locations are available to the program playing.
#
####################################################################################################################################################################################################################################
############################################################################################################# ARGUMENTS ############################################################################################################
####################################################################################################################################################################################################################################
