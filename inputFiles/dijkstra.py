...
def initializationCode (mazeMap, timeAllowed, playerLocation, opponentLocation, coins) :
    ...
    # We compute the shortest paths to all locations using Dijkstra's algorithm, and extract the path to the coin
    predecessors = dijkstra(mazeMap, playerLocation)
    shortestPathToCoin = [coins[0]]
    ...
    for l in range(len(shortestPathToCoin) - 1) :
        resultMoves.append(locationsToMove(shortestPathToCoin[l], shortestPathToCoin[l + 1]))
