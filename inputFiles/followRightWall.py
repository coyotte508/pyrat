...
TEAM_NAME = "Follow right wall"

####################################################################################################################################################################################################################################
########################################################################################################## YOUR VARIABLES ##########################################################################################################
####################################################################################################################################################################################################################################

# Stores the previous location

previousLocation = (-1, -1)

####################################################################################################################################################################################################################################

# Stores the last tested move
...
# Returns true if the last decision made the token move

def hasMoved (newLocation) :
    
    # We check the equality
    return previousLocation != newLocation
...
def determineNextMove (mazeMap, timeAllowed, playerLocation, opponentLocation, coins) :
    ...
    # If we did change location
    if hasMoved(playerLocation) :
